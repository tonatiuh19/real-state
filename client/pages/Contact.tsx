...
const Contact: React.FC = () => {
  ...
  return (
    <div className="flex flex-col">
      <MetaHelmet
        title="Contact Us | Encore Mortgage"
        description="Get in touch with Encore Mortgage. Call, email, or send us a message — our loan officers are ready to help you find the right mortgage."
        keywords="contact Encore Mortgage, mortgage banker, Whittier CA, (562) 337-0000, mortgage questions"
      />
                    ...
                    <>
                      ...
                      >
                        ...
                        <p className="text-xs text-muted-foreground text-center">
                          ...
                          Encore Mortgage regarding your inquiry.
                        </p>
                      </form>
                    </>
                  )}
