...
const About: React.FC = () => {
  return (
    <div className="flex flex-col">
      <MetaHelmet
        title="About Us | Encore Mortgage"
        description="Learn about Encore Mortgage's story, our team of experienced mortgage bankers, and our mission to make homeownership accessible to every family."
        keywords="Encore Mortgage, about us, mortgage banker, Daniel Carrillo, Alex Gomez, Whittier CA, home loans team"
      />
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                The story of Encore Mortgage begins in Montebello, CA, where our
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                Today, Encore Mortgage serves clients across California and
