...
const NewLoanWizard: React.FC<NewLoanWizardProps> = ({
  ...
  // Mode selection: null = show choice, 'manual' = wizard, 'share' = share link modal
  type LoanMode = null | "manual" | "share";
  const [mode, setMode] = useState<LoanMode>(null);
  ...
  const handleSelectMode = (selectedMode: "manual" | "share") => {
    if (selectedMode === "share") {
      // Close the wizard and open the share link modal
      setMode("share");
      onOpenChange(false);
    ...
    <>
      ...
      >
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
              ...
              >
                ...
                <div className="mb-6 text-center">
                  ...
                  <p className="text-gray-500 text-sm">
                    How would you like to create this loan application?
                  </p>
                </div>

                {/* Primary card — Share Link */}
                <motion.button
                  whileHover={{ scale: 1.01 }}
                  whileTap={{ scale: 0.99 }}
                  onClick={() => handleSelectMode("share")}
                  className="group relative w-full flex flex-col items-start gap-4 rounded-2xl border-2 border-primary/30 bg-primary/5 p-6 text-left shadow-sm hover:border-primary hover:shadow-md hover:bg-primary/10 transition-all mb-3"
                >
                  {/* Badge */}
                  <span className="absolute top-4 right-4 text-[10px] font-semibold bg-primary text-white rounded-full px-2.5 py-0.5 tracking-wide uppercase">
                    Recommended
                  </span>

                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/15 group-hover:bg-primary transition-colors">
                    <Share2 className="h-7 w-7 text-primary group-hover:text-white transition-colors" />
                  </div>
                  ...
                  <div className="flex-1 pr-16">
                    ...
                    <p className="text-sm text-gray-500 leading-relaxed">
                      Send your client a personalized link so they can fill out
                      their own application — your profile is shown first.
                    </p>
                  </div>

                  <div className="flex items-center gap-1.5 text-sm text-primary font-semibold">
                    Get link <ChevronRight className="h-4 w-4" />
                  </div>
                </motion.button>
                ...
                <motion.button
                  ...
                  className="group w-full flex items-center gap-4 rounded-xl border border-gray-200 bg-white px-4 py-3 text-left hover:border-gray-300 hover:bg-gray-50 transition-all"
                >
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gray-100 group-hover:bg-gray-200 transition-colors">
                    <ClipboardEdit className="h-4.5 w-4.5 h-[18px] w-[18px] text-gray-500" />
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-400 truncate">
                      Fill in the details yourself via the step-by-step wizard
                    </p>
                  </div>
          ...
          {/* ── Existing wizard content — only shown when mode = 'manual' ── */}
          {mode === "manual" && (
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  Fill in the details to create a new loan application and
                  assign tasks
                </DialogDescription>
                {isDev && (
                  <Button
                    ...
                    {isAdmin && (
                      <div className="pt-4 border-t">
                        ...
                        <p className="text-xs text-muted-foreground mt-2">
                          Assign this loan to yourself or another broker in your
                          team.
                        </p>
                      </div>
                    )}
                  ...
                  <div className="space-y-6 animate-in fade-in slide-in-from-right-5 duration-300">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        Select task templates to assign to this loan. The client
                        will receive an email with instructions for each task.
                      </p>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-amber-700 mb-3">
                                ...
                                templates to quickly assign common tasks to
                                loans.
                              </p>
                              <Button
                                type="button"
                      ...
                      <div className="p-3 border border-dashed rounded-lg bg-muted/20">
                        ...
                        <p className="text-xs text-blue-600 dark:text-blue-400 mt-3 flex items-start gap-1.5">
                          ...
                          <span>
                            Don't worry! Your progress will be saved as a draft.
                            You can resume this loan application anytime.
                          </span>
                        </p>
                      </div>
                    </div>
