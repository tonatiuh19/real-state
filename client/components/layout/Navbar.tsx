...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: "Broker Dashboard", href: "/admin" },
  ];
  ...
  return (
    <nav className="sticky top-4 z-50 w-[95%] mx-auto max-w-7xl">
      <div className={cn(
        ...
        isHome ? "border border-white/20 hover:border-white/40" : "border-transparent"
      )}>
        ...
        <div className="relative flex h-16 items-center justify-between px-6 rounded-2xl bg-background/40">
          <div className="flex items-center gap-2">
            <Link to="/" className="flex items-center space-x-2 transition-transform hover:scale-105">
              ...
              <span className="text-xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">NexusBroker</span>
            </Link>
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-3">
              <Link to="/login">
                <Button variant="ghost" size="sm" className="font-semibold hover:bg-white/10 transition-colors">Sign In</Button>
              </Link>
              <Link to="/apply">
              <Button size="sm" className="font-bold shadow-lg shadow-primary/20 px-6 rounded-xl hover:scale-105 active:scale-95 transition-all">Get Started</Button>
            </Link>
            </div>
            <button
        ...
        <div className={cn(
          ...
          <div className="container space-y-1 pb-3 pt-2">
            {navLinks.map((link) => (
              <Link
                ...
                className={cn(
                  ...
                  location.pathname === link.href ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-white/5"
                )}
            ...
            <div className="mt-4 flex flex-col gap-2 px-1 pb-2">
              <Button variant="outline" className="w-full rounded-xl border-white/20 hover:bg-white/10">Sign In</Button>
              <Link to="/apply">
                <Button className="w-full rounded-xl font-bold shadow-lg shadow-primary/20">Get Started</Button>
              </Link>
            </div>
          </div>
        </div>
